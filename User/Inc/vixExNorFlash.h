...
#ifndef INC_VIXEXNORFLASH_H_
#define INC_VIXEXNORFLASH_H_

/* MX25L51245G Macronix memory */
/* Size of the flash */

#define MX25L51245G_FLASH_SIZE                   0x4000000 /* 512 MBits => 64 MBytes */
#define MX25L51245G_BLOCK_SIZE                   0x10000   /* 1024 blocks of 64 KBytes */
#define MX25L51245G_SECTOR_SIZE                  0x1000    /* 16384 sectors of 4 kBytes */
#define MX25L51245G_PAGE_SIZE                    0x100     /* 262144 pages of 256 bytes */

#define QSPI_SECTOR_SIZE                         MX25L51245G_BLOCK_SIZE
#define QSPI_SUBSECTOR_SIZE                      MX25L51245G_SECTOR_SIZE
#define QSPI_PAGE_SIZE                           MX25L51245G_PAGE_SIZE
...
#define QSPI_BULK_ERASE_MAX_TIME         					500000
...
/***** READ/WRITE Array Commands with 3/4 Byte Address ****************************/
#define MX25L51245G_READ_CMD                               		0x03U   /*!< Normal Read 3/4 Byte Address */
#define MX25L51245G_FAST_READ_CMD                        		0x0BU   /*!< Fast Read 3/4 Byte Address */
#define MX25L51245G_2READ_CMD                                   0xBBU
#define MX25L51245G_DREAD_CMD                                   0x3BU
#define MX25L51245G_4READ_CMD                                   0xEBU
#define MX25L51245G_QREAD_CMD                                   0x6BU
#define MX25L51245G_FAST_DTRD_CMD                               0x0DU
#define MX25L51245G_2DTRD_CMD                                   0xBDU
#define MX25L51245G_4DTRD_CMD                                   0xEDU
#define MX25L51245G_PAGE_PROG_CMD                        				0x02U   /*!< Page Program 3/4 Byte Address */
#define MX25L51245G_4PAGE_PROG_CMD                        				0x38U
#define MX25L51245G_SECTOR_ERASE_4K_CMD               		    	0x20U   /*!< SubSector Erase 4KB 3/4 Byte Address */
#define MX25L51245G_BLOCK_ERASE_32K_CMD                             0x52U
#define MX25L51245G_BLOCK_ERASE_64K_CMD                 			0xD8U   /*!< Block Erase 64KB 3/4 Byte Address */
#define MX25L51245G_CHIP_ERASE_CMD                       				0x60U   /*!< Bulk Erase */

/***** READ/WRITE MEMORY Operations with 4-Byte Address Command Set ****************************/
#define MX25L51245G_4_BYTE_ADDR_READ_CMD                 			0x13U   /*!< Normal Read 4 Byte address */
#define MX25L51245G_4_BYTE_ADDR_FAST_READ_CMD            			0x0CU   /*!< Fast Read 4 Byte address */
#define MX25L51245G_4_BYTE_ADDR_2READ_CMD            			0xBCU
#define MX25L51245G_4_BYTE_PAGE_PROG_CMD                 			0x12U   /*!< Page Program 4 Byte Address */
#define MX25L51245G_4_BYTE_SECTOR_ERASE_4K_CMD      		0x21U   /*!< SubSector Erase 4KB 4 Byte Address */
#define MX25L51245G_4_BYTE_BLOCK_ERASE_64K_CMD          		0xDCU   /*!< Sector Erase 64KB 4 Byte Address */

/***** Setting commands ************************************************************/
#define MX25L51245G_WRITE_ENABLE_CMD                     				0x06U   /*!< Write Enable */
#define MX25L51245G_WRITE_DISABLE_CMD                    				0x04U   /*!< Write Disable */
#define MX25L51245G_PROG_ERASE_SUSPEND_CMD            			0xB0U   /*!< Program/Erase suspend */
#define MX25L51245G_PROG_ERASE_RESUME_CMD                			0x30U   /*!< Program/Erase resume */
#define MX25L51245G_ENTER_DEEP_POWER_DOWN_CMD           		0xB9U   /*!< Enter deep power down */
#define MX25L51245G_SET_BURST_LENGTH_CMD                 			0xC0U   /*!< Set burst length */
#define MX25L51245G_ENTER_SECURED_OTP_CMD                			0xB1U   /*!< Enter secured OTP) */
#define MX25L51245G_EXIT_SECURED_OTP_CMD                 			0xC1U   /*!< Exit secured OTP) */

/***** RESET commands ************************************************************/
#define MX25L51245G_NOP_CMD                              					0x00U   /*!< No operation */
#define MX25L51245G_RESET_ENABLE_CMD                     				0x66U   /*!< Reset Enable */
#define MX25L51245G_RESET_MEMORY_CMD                     				0x99U   /*!< Reset Memory */
...
#define MX25L51245G_READ_STATUS_REG_CMD                  			0x05U   /*!< Read Status Register */
#define MX25L51245G_READ_CFG_REG_CMD                    			0x15U   /*!< Read configuration Register */
#define MX25L51245G_WRITE_STATUS_REG_CMD                 			0x01U   /*!< Write Status Register */
#define MX25L51245G_ENTER_4BYTE_MODE_CMD                            0xB7U   /*!< Status Register Bit5 set to "1", 4-byte address mode enabled */
#define MX25L51245G_EXIT_4BYTE_MODE_CMD                             0xE9U   /*!< Status Register Bit5 set to "0", 3-byte address mode enabled */
#define MX25L51245G_READ_ID_CMD                       				0x9FU   /*!< Read IDentification */
/*******************************************************************/
/********************************* OPI  ****************************/
/*******************************************************************/
...
/******************************************************************************
  ...
  ****************************************************************************/
/* Status Register */
#define MX25L51245G_SR_WIP						0x01U   /*!< Write in progress */
#define MX25L51245G_SR_WEL						0x02U   /*!< Write enable latch */
...
/**
  * @brief  MX25L51245G Timing configuration
  */
#define MX25L51245G_BULK_ERASE_MAX_TIME          	     		200000U
#define MX25L51245G_BLOCK_64K_ERASE_MAX_TIME        			2000U
#define MX25L51245G_BLOCK_32K_ERASE_MAX_TIME        			1000U
#define MX25L51245G_SECTOR_4K_ERASE_MAX_TIME  		            400U
...
ErrState xOSPI_ReadFlash(uint32_t ReadAddr, uint8_t* pData, uint16_t Length);


void OPEN_ExNorFlash(void);


ErrState xOSPI_WriteConfig(OSPI_HandleTypeDef *hospi);
...
void burstReadExtFlash(uint32_t ReadAddr, uint8_t* pData, uint16_t Length);

ErrState xWRITE_DataToExNorFlash(uint32_t WriteAddr, uint8_t* pData, uint16_t Length);

#endif /* INC_VIXEXNORFLASH_H_ */
